...
<?php if($currentWallet == PayCoin):?>
            <a href="listminting" class='btn btn-default' role='button'>Get Staking Info</a>
<?php elseif($currentWallet == BottleCaps || $currentWallet == CASH || $currentWallet == Diamond || $currentWallet == HoboNickels || $currentWallet == NovaCoin || $currentWallet == PhilosopherStone):?>
